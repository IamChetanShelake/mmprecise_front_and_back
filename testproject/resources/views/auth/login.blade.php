...
<head>
    ...
    <title>{{ config('app.name', 'MM Precise Admin') }} - Login</title>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <div class="brand-section">
                <div class="brand-logo">
                    <img src="{{ asset('images/MM Precise.png') }}" alt="MM Precise Logo">
                </div>
                <h1 class="brand-title">MM Precise</h1>
                <p class="brand-subtitle">Contractor Management Portal</p>

                <ul class="features-list">
                    <li><i class="fas fa-users"></i> Contractor Management</li>
                    <li><i class="fas fa-clock"></i> Project Tracking</li>
                    <li><i class="fas fa-calendar-times"></i> Schedule Management</li>
        ...
        <div class="login-right">
            <div class="login-header">
                ...
                <p class="login-subtitle">Sign in to access your contractor dashboard</p>
            </div>
            ...
            <div class="footer-text">
                ...
                Secure login powered by MM Precise
            </div>
        </div>
    </div>
