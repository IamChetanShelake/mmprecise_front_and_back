...
<div id="create-expertise" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Create Expertise</h1>
                    <p class="hero-subtitle">Set up the three main expertise sections</p>
                </div>
            </div>
    ...
    <div class="hero-content">
        <div class="form-container">
            <form action="{{ route('admin.expertise.store') }}" method="POST" enctype="multipart/form-data" class="expertise-form">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="main_title" id="main_title" class="form-control"
                                   placeholder="Enter main title" value="{{ old('main_title') }}">
                            @error('main_title')
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="main_description" id="main_description" class="form-control" rows="4"
                                  placeholder="Describe the main expertise section...">{{ old('main_description') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="second_title" id="second_title" class="form-control"
                                   placeholder="Enter second item title" value="{{ old('second_title') }}">
                            @error('second_title')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div id="second-points-container">
                            @if(old('second_points'))
                                @foreach(old('second_points') as $index => $point)
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="third_title" id="third_title" class="form-control"
                                   placeholder="Enter third item title" value="{{ old('third_title') }}">
                            @error('third_title')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div id="third-points-container">
                            @if(old('third_points'))
                                @foreach(old('third_points') as $index => $point)
                                    <div class="point-input-group">
...
<style>
/* Create Expertise Section Specific Styles */
#create-expertise .btn-back {
...
#create-expertise .btn-back:hover {
...
#create-expertise .section-header {
    margin-bottom: 2rem;
    padding-bottom: 1rem;
    border-bottom: 2px solid #f3f4f6;
}

#create-expertise .section-title {
    display: flex;
    align-items: center;
    gap: 0.75rem;
    font-size: 1.5rem;
...
#create-expertise .section-title i {
    color: #FF6B35;
    font-size: 1.75rem;
}

#create-expertise .section-description {
    color: #6b7280;
    font-size: 0.875rem;
    margin: 0;
}
...
/* Form Groups */
#create-expertise .form-group {
    display: flex;
    flex-direction: column;
    gap: 0.5rem;
}

#create-expertise .form-group.full-width {
    grid-column: 1 / -1;
}

#create-expertise .form-label {
    display: flex;
    align-items: center;
    gap: 0.5rem;
    font-weight: 600;
...
#create-expertise .form-label i {
    color: #FF6B35;
    font-size: 1rem;
}

#create-expertise .form-control {
...
#create-expertise .form-control:focus {
    outline: none;
    border-color: #FF6B35;
    box-shadow: 0 0 0 3px rgba(255, 107, 53, 0.1);
}

#create-expertise .form-control::placeholder {
    color: #9ca3af;
}

#create-expertise textarea.form-control {
    resize: vertical;
    min-height: 100px;
}

#create-expertise .form-help {
    font-size: 0.75rem;
    color: #6b7280;
    margin-top: 0.25rem;
}

#create-expertise .error-message {
    font-size: 0.75rem;
    color: #dc3545;
    margin-top: 0.25rem;
    display: flex;
...
#create-expertise .error-message::before {
    content: '⚠';
    font-size: 0.875rem;
}

/* Points Management */
#create-expertise .point-input-group {
    display: flex;
    gap: 0.5rem;
...
#create-expertise .point-input {
    flex: 1;
}

#create-expertise .btn-remove-point {
    width: 40px;
    height: 40px;
    border-radius: 6px;
    border: none;
...
#create-expertise .btn-remove-point:hover {
    background: #d32f2f;
    color: white;
    transform: scale(1.1);
}

#create-expertise .btn-add-point {
...
#create-expertise .btn-add-point:hover {
    transform: translateY(-2px);
...
/* Status Toggle */
#create-expertise .status-toggle {
    margin-top: 0.5rem;
}

#create-expertise .toggle-label {
    display: flex;
    align-items: center;
    gap: 0.75rem;
    cursor: pointer;
...
#create-expertise .toggle-label input[type="checkbox"] {
    display: none;
}

#create-expertise .toggle-slider {
    position: relative;
    width: 50px;
    height: 24px;
    background: #ccc;
...
#create-expertise .toggle-slider::before {
    content: '';
    position: absolute;
    top: 2px;
    left: 2px;
...
#create-expertise .toggle-label input[type="checkbox"]:checked + .toggle-slider {
    background: linear-gradient(135deg, #28a745 0%, #20c997 100%);
}

#create-expertise .toggle-label input[type="checkbox"]:checked + .toggle-slider::before {
    transform: translateX(26px);
}

#create-expertise .toggle-text {
    font-size: 0.875rem;
    font-weight: 600;
}

/* Form Actions */
#create-expertise .form-actions {
    display: flex;
...
#create-expertise .btn-cancel:hover {
    background: #e5e7eb;
    color: #1f2937;
    transform: translateY(-2px);
}

#create-expertise .btn-submit {
...
#create-expertise .btn-submit:hover {
    transform: translateY(-2px);
...
#create-expertise .hero-header-content {
    display: flex;
...
#create-expertise .hero-header-left {
    display: flex;
    align-items: center;
    gap: 1.5rem;
}

#create-expertise .hero-icon {
    width: 64px;
    height: 64px;
    background: rgba(255, 255, 255, 0.2);
    border-radius: 16px;
...
#create-expertise .hero-icon i {
    font-size: 2rem;
    color: white;
}

#create-expertise .hero-title-section h1 {
    color: white;
    font-size: 2rem;
    font-weight: 700;
    margin: 0;
...
#create-expertise .hero-subtitle {
