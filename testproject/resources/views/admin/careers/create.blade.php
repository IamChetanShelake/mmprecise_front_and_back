...
<div id="careers-create" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Add Career Opening</h1>
                    <p class="hero-subtitle">Create a new job opening for your organization</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.careers.store') }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-section">
                        ...
                        <p class="section-description">Enter the fundamental details of the job opening</p>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('years_experience') is-invalid @enderror"
                                    ...
                                    <option value="0-1 years" {{ old('years_experience') == '0-1 years' ? 'selected' : '' }}>0-1 years</option>
                                    <option value="1-3 years" {{ old('years_experience') == '1-3 years' ? 'selected' : '' }}>1-3 years</option>
                                    <option value="3-5 years" {{ old('years_experience') == '3-5 years' ? 'selected' : '' }}>3-5 years</option>
                                    <option value="5-8 years" {{ old('years_experience') == '5-8 years' ? 'selected' : '' }}>5-8 years</option>
                                    <option value="8-10 years" {{ old('years_experience') == '8-10 years' ? 'selected' : '' }}>8-10 years</option>
                                    <option value="10+ years" {{ old('years_experience') == '10+ years' ? 'selected' : '' }}>10+ years</option>
                                </select>
                    ...
                    <div class="form-section">
                        ...
                        <p class="section-description">Add the key skills required for this position</p>
                    ...
                    <div class="form-section">
                        ...
                        <p class="section-description">Describe the main responsibilities and duties</p>

                        <div class="form-group">
                            <textarea class="form-control @error('responsibilities') is-invalid @enderror"
                                      id="responsibilities" name="responsibilities" rows="6"
                                      placeholder="Describe the key responsibilities, duties, and expectations for this role...">{{ old('responsibilities') }}</textarea>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        ...
                        <span>Create Career Opening</span>
                    </button>
