...
<div id="company-overview" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Edit Company Overview</h1>
                    <p class="form-subtitle">Update your company's story, achievements, and mission</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.company-overview.update', $companyOverview->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-input" id="title" name="title" value="{{ old('title', $companyOverview->title) }}" placeholder="Enter section title" required>
                        </div>
                        @error('title')
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea class="form-textarea" id="first_description" name="first_description" rows="4" placeholder="Enter company description" required>{{ old('first_description', $companyOverview->first_description) }}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <i class="bi bi-textarea-resize input-icon"></i>
                                <textarea class="form-textarea" id="second_description" name="second_description" rows="4" placeholder="Enter additional information" required>{{ old('second_description', $companyOverview->second_description) }}</textarea>
                            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="number" class="form-input" id="years_experience" name="years_experience" value="{{ old('years_experience', $companyOverview->years_experience) }}" min="0" placeholder="e.g. 25" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="number" class="form-input" id="projects_completed" name="projects_completed" value="{{ old('projects_completed', $companyOverview->projects_completed) }}" min="0" placeholder="e.g. 150" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="number" class="form-input" id="expert_engineers" name="expert_engineers" value="{{ old('expert_engineers', $companyOverview->expert_engineers) }}" min="0" placeholder="e.g. 50" required>
                            </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea class="form-textarea" id="vision_description" name="vision_description" rows="3" placeholder="Describe your company's vision" required>{{ old('vision_description', $companyOverview->vision_description) }}</textarea>
                        </div>
                            ...
                            <div id="mission-points">
                                @if($companyOverview->mission_points && count($companyOverview->mission_points) > 0)
                                    @foreach($companyOverview->mission_points as $index => $point)
                                        @if(!empty(trim($point)))
                                            <div class="mission-point-item" id="mission-point-{{ $index + 1 }}">
                                                <span class="mission-point-number">{{ $index + 1 }}</span>
                                                <input type="text" name="mission_points[]" class="mission-point-input" value="{{ $point }}" placeholder="Enter mission point {{ $index + 1 }}" maxlength="500">
                                                <button type="button" class="btn-remove-mission" onclick="removeMissionPoint({{ $index + 1 }})">
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-wrapper">
                            <label class="toggle-switch">
                                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $companyOverview->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        ...
                        <span>Update Company Overview</span>
                    </button>
            ...
            <div class="info-card">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $companyOverview->created_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Last Updated:</span>
                        <span class="info-value">{{ $companyOverview->updated_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Status:</span>
                        <span class="info-value {{ $companyOverview->is_active ? 'status-active' : 'status-inactive' }}">
...
<script>
let missionPointCount = parseInt('{{ count($companyOverview->mission_points ?? []) }}');
