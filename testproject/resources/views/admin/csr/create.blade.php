...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-plus-circle"></i> Create New CSR Initiative</h2>
    ...
    <form action="{{ route('admin.csr.store') }}" method="POST" enctype="multipart/form-data" id="csrForm">
        @csrf
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="main_title" name="main_title" value="{{ old('main_title') }}" required>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="main_description" name="main_description" rows="3" placeholder="Describe the overall CSR initiative...">{{ old('main_description') }}</textarea>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="short_description" class="form-label">Short Description <small class="text-muted">(Optional)</small></label>
                        <textarea class="form-control" id="short_description" name="short_description" rows="2" maxlength="1000" placeholder="Brief summary (max 1000 characters)...">{{ old('short_description') }}</textarea>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Create CSR Initiative
                    </button>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    let positiveChangeIndex = 1;
    let measurableResultIndex = 1;
    let greenConstructionIndex = 1;
