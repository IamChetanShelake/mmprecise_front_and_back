...
<div id="hero" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Edit Hero Section</h1>
                    <p class="form-subtitle">Update your website's hero section content</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.hero.update', $hero->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="first_title" name="first_title" value="{{ old('first_title', $hero->first_title) }}" placeholder="Enter main headline" required>
                            </div>
                            @error('first_title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="second_title" name="second_title" value="{{ old('second_title', $hero->second_title) }}" placeholder="Enter secondary headline" required>
                            </div>
                            @error('second_title')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
            ...
            <div class="info-card">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $hero->created_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Last Updated:</span>
                        <span class="info-value">{{ $hero->updated_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Status:</span>
                        <span class="info-value {{ $hero->is_active ? 'status-active' : 'status-inactive' }}">
