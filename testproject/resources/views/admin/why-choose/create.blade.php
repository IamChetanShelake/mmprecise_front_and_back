...
<div id="why-choose-create" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Create Why Choose Section</h1>
                    <p class="hero-subtitle">Add a compelling "Why Choose Us" section to highlight your advantages</p>
                </div>
            </div>
    ...
    <div class="hero-content">
        <div class="form-container">
            <form action="{{ route('admin.why-choose.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                               value="{{ old('title') }}" placeholder="e.g., Why Choose Us" required>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="8"
                                  placeholder="Describe why customers should choose your company">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
