...
@section('content')
<!-- Edit Business Hours Section -->
<div id="business-hours-edit" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Edit Business Hours</h1>
                    <p class="hero-subtitle">Update office timings for Monday to Friday and Sunday settings</p>
                </div>
            </div>
    ...
    <div class="hero-content">
        <div class="form-container">
            <form action="{{ route('admin.business-hours.update', $businessHours->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="hours-section">
                        ...
                        <p class="section-description">Update operating hours for all weekdays</p>
                        ...
                        <div class="time-inputs">
                            <div class="time-group">
                                ...
                                <input type="time" class="form-control time-input" id="weekday_from" name="monday_from"
                                       value="{{ old('monday_from', $businessHours->monday_from) }}" required>
                            ...
                            <div class="time-group">
                                ...
                                <input type="time" class="form-control time-input" id="weekday_to" name="monday_to"
                                       value="{{ old('monday_to', $businessHours->monday_to) }}" required>
                        ...
                        <!-- Individual weekday inputs -->
                        <div class="individual-weekdays" id="individualWeekdays" style="display: none;">
                            <div class="weekday-row">
                                <span class="weekday-name">Tuesday:</span>
                                <input type="time" class="form-control time-input" name="tuesday_from" value="{{ old('tuesday_from', $businessHours->tuesday_from) }}">
                                <span class="time-separator">to</span>
                                <input type="time" class="form-control time-input" name="tuesday_to" value="{{ old('tuesday_to', $businessHours->tuesday_to) }}">
                            </div>
                            <div class="weekday-row">
                                <span class="weekday-name">Wednesday:</span>
                                <input type="time" class="form-control time-input" name="wednesday_from" value="{{ old('wednesday_from', $businessHours->wednesday_from) }}">
                                <span class="time-separator">to</span>
                                <input type="time" class="form-control time-input" name="wednesday_to" value="{{ old('wednesday_to', $businessHours->wednesday_to) }}">
                            </div>
                            <div class="weekday-row">
                                <span class="weekday-name">Thursday:</span>
                                <input type="time" class="form-control time-input" name="thursday_from" value="{{ old('thursday_from', $businessHours->thursday_from) }}">
                                <span class="time-separator">to</span>
                                <input type="time" class="form-control time-input" name="thursday_to" value="{{ old('thursday_to', $businessHours->thursday_to) }}">
                            </div>
                            <div class="weekday-row">
                                <span class="weekday-name">Friday:</span>
                                <input type="time" class="form-control time-input" name="friday_from" value="{{ old('friday_from', $businessHours->friday_from) }}">
                                <span class="time-separator">to</span>
                                <input type="time" class="form-control time-input" name="friday_to" value="{{ old('friday_to', $businessHours->friday_to) }}">
                            </div>
                        </div>
                    ...
                    <div class="hours-section">
                        ...
                        <div class="weekend-day-section">
                            ...
                            <div class="sunday-options">
                                <div class="option-group">
                                    <label class="radio-option">
                                        <input type="radio" name="saturday_status" value="closed"
                                               {{ old('saturday_status', $businessHours->saturday_status) === 'closed' ? 'checked' : '' }}>
                                    ...
                                    <label class="radio-option">
                                        <input type="radio" name="saturday_status" value="open"
                                               {{ old('saturday_status', $businessHours->saturday_status) === 'open' ? 'checked' : '' }}>
                                        <span class="radio-label">
                                ...
                                <div class="sunday-timing" id="saturdayTiming" style="{{ old('saturday_status', $businessHours->saturday_status) === 'open' ? '' : 'display: none;' }}">
                                    <div class="time-inputs">
                                        <div class="time-group">
                                            ...
                                            <input type="time" class="form-control time-input" id="saturday_from" name="saturday_from"
                                                   value="{{ old('saturday_from', $businessHours->saturday_from) }}">
                                            <small class="time-help">e.g., 9:00 AM</small>
                                        </div>
                                        ...
                                        <div class="time-group">
                                            ...
                                            <input type="time" class="form-control time-input" id="saturday_to" name="saturday_to"
                                                   value="{{ old('saturday_to', $businessHours->saturday_to) }}">
                        ...
                        <div class="weekend-day-section">
                            ...
                            <div class="sunday-options">
                                <div class="option-group">
                                    <label class="radio-option">
                                        <input type="radio" name="sunday_status" value="closed"
                                               {{ old('sunday_status', $businessHours->sunday_status) === 'closed' ? 'checked' : '' }}>
                                        <span class="radio-label">
                                            <i class="bi bi-x-circle"></i>
                                            <strong>Closed</strong>
                                    ...
                                    <label class="radio-option">
                                        <input type="radio" name="sunday_status" value="open"
                                               {{ old('sunday_status', $businessHours->sunday_status) === 'open' ? 'checked' : '' }}>
                                        <span class="radio-label">
                                            <i class="bi bi-check-circle"></i>
                                            <strong>Open</strong>
                                ...
                                <div class="sunday-timing" id="sundayTiming" style="{{ old('sunday_status', $businessHours->sunday_status) === 'open' ? '' : 'display: none;' }}">
                                    <div class="time-inputs">
                                        <div class="time-group">
                                            ...
                                            <input type="time" class="form-control time-input" id="sunday_from" name="sunday_from"
                                                   value="{{ old('sunday_from', $businessHours->sunday_from) }}">
                                        ...
                                        <div class="time-group">
                                            ...
                                            <input type="time" class="form-control time-input" id="sunday_to" name="sunday_to"
                                                   value="{{ old('sunday_to', $businessHours->sunday_to) }}">
                    ...
                    <div class="status-section">
                        ...
                        <div class="status-toggle">
                            <label class="toggle-switch">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $businessHours->is_active) ? 'checked' : '' }}>
