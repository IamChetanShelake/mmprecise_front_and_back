...
<div id="partners" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Add New Partner</h1>
                    <p class="form-subtitle">Add a new business partner or collaboration to your network</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.partners.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-input" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Google, Microsoft, TechCorp" required>
                        </div>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" class="form-input" id="sort_order" name="sort_order" value="{{ old('sort_order', 0) }}" placeholder="0 = first, higher numbers = later">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="icon_type" id="use_icon" value="icon" checked>
                                ...
                                <select class="form-select" id="icon" name="icon">
                                    ...
                                    <option value="bi-microsoft">Microsoft</option>
                                    <option value="bi-apple">Apple</option>
            ...
            <div class="stats-card">
                ...
                <div class="stats-content">
                    <div class="field-requirement">
                        <span class="field-name">Partner Name:</span>
                        <span class="field-status required">Required</span>
                    </div>
                    <div class="field-requirement">
                        <span class="field-name">Icon/Image:</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        if (iconRadio.checked && iconSelect.value) {
            const selectedOption = iconSelect.options[iconSelect.selectedIndex];
            const iconName = selectedOption ? selectedOption.text : 'Icon';
            previewIcon.className = `bi ${iconSelect.value}`;
            previewIcon.style.color = '#FF6B35';
            previewText.textContent = iconName;
        } else if (imageRadio.checked && imageInput.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                if (!img) {
                    ...
                    previewIcon.parentNode.insertBefore(img, previewIcon);
                }
            ...
            previewIcon.className = 'bi bi-handshake';
            previewIcon.style.color = '#FF6B35';
            previewText.textContent = 'Select an icon or upload an image';
        }
    }
