...
<div id="clients-feedback" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Edit Client Feedback</h1>
                    <p class="form-subtitle">Update feedback from "{{ $clientFeedback->feedbacker_name }}"</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.clients-feedback.update', $clientFeedback->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="feedbacker_name" name="feedbacker_name" value="{{ old('feedbacker_name', $clientFeedback->feedbacker_name) }}" placeholder="Full name of the client" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="feedbacker_role" name="feedbacker_role" value="{{ old('feedbacker_role', $clientFeedback->feedbacker_role) }}" placeholder="e.g. CEO, Project Manager, Client" required>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <textarea class="form-textarea" id="feedback_description" name="feedback_description" rows="6" placeholder="Enter the client's feedback or testimonial..." required>{{ old('feedback_description', $clientFeedback->feedback_description) }}</textarea>
                        </div>
                ...
                <div class="form-section">
                        ...
                        <div class="star-rating-container">
                            <div class="rating-header">
                                ...
                                <div class="rating-display">
                                    <span class="rating-number" id="ratingNumber">{{ old('feedback_star_rate', $clientFeedback->feedback_star_rate) }}</span>
                                    <span class="rating-stars">
                                        @for($i = 1; $i <= 5; $i++)
                                            <i class="bi bi-star-fill star-display {{ $i <= old('feedback_star_rate', $clientFeedback->feedback_star_rate) ? 'active' : '' }}" data-star="{{ $i }}"></i>
                                        @endfor
                                    </span>
                                </div>
                            </div>
                            <div class="star-rating-input">
                                <div class="stars-interactive">
                                    @for($i = 1; $i <= 5; $i++)
                                        <input type="radio" id="star{{ $i }}" name="feedback_star_rate" value="{{ $i }}" {{ old('feedback_star_rate', $clientFeedback->feedback_star_rate) == $i ? 'checked' : '' }} required>
                                ...
                                <div class="rating-feedback">
                                    <span class="rating-text" id="ratingText">
                                        @php
                                            $rating = old('feedback_star_rate', $clientFeedback->feedback_star_rate);
                                            $descriptions = ['Poor (1 Star)', 'Fair (2 Stars)', 'Good (3 Stars)', 'Very Good (4 Stars)', 'Excellent (5 Stars)'];
                                            echo $descriptions[$rating - 1];
                                        @endphp
                                    </span>
                                    <div class="rating-progress">
                                        <div class="progress-bar" id="ratingProgress" style="width: {{ (old('feedback_star_rate', $clientFeedback->feedback_star_rate) / 5) * 100 }}%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        @if($clientFeedback->feedback_image)
                            <div class="current-image-display">
                                <small class="text-muted">Current image:</small>
                                <div class="current-image-wrapper">
                                    <img src="{{ asset($clientFeedback->feedback_image) }}" alt="Current Client Image" class="current-image">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" class="form-input" id="sort_order" name="sort_order" value="{{ old('sort_order', $clientFeedback->sort_order) }}" min="0" placeholder="Display order (0 = first)">
                        </div>
                        @error('sort_order')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-wrapper">
                            <label class="toggle-switch">
                                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $clientFeedback->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        ...
                        <span>Update Client Feedback</span>
                    </button>
            ...
            <div class="info-card">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $clientFeedback->created_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Last Updated:</span>
                        <span class="info-value">{{ $clientFeedback->updated_at->format('M d, Y H:i') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Status:</span>
                        <span class="info-value {{ $clientFeedback->is_active ? 'status-active' : 'status-inactive' }}">
                            {{ $clientFeedback->is_active ? 'Active' : 'Inactive' }}
                        </span>
                    </div>
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            @for($i = 1; $i <= 5; $i++)
                                <i class="bi bi-star{{ $i <= $clientFeedback->feedback_star_rate ? '-fill' : '' }} star-small {{ $i <= $clientFeedback->feedback_star_rate ? 'active' : '' }}"></i>
                            @endfor
                            <span class="rating-number">({{ $clientFeedback->feedback_star_rate }})</span>
                        </span>
                    </div>
                </div>
            </div>
