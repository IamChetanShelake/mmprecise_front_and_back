...
<div id="achievements" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Add Achievement</h1>
                    <p class="form-subtitle">Add a new achievement or award to showcase your company's success</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-input" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Best Engineering Firm 2024" required>
                        </div>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <textarea class="form-textarea" id="description" name="description" rows="6" placeholder="Describe the achievement, award details, and significance..." required>{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
