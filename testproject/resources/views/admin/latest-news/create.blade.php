...
<div id="latest-news-create" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Create News Article</h1>
                    <p class="hero-subtitle">Add a new news article with rich content and highlights</p>
                </div>
            </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="main_title" name="main_title"
                               value="{{ old('main_title') }}" placeholder="Enter the main news title" required>
                        @error('main_title')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" id="description" name="description" rows="6"
                                  placeholder="Write the detailed news description...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="news_quote_description" name="news_quote_description" rows="3"
                                  placeholder="Enter the news quote or testimonial">{{ old('news_quote_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="news_feedbacker" name="news_feedbacker"
                               value="{{ old('news_feedbacker') }}" placeholder="e.g., John Smith, CEO">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="last_description" name="last_description" rows="4"
                                  placeholder="Any additional information or conclusion">{{ old('last_description') }}</textarea>
