...
@section('content')
<!-- Create Featured Highlight Section -->
<div id="featured-highlight-create" class="section active">
    <!-- Modern Header -->
        ...
        <div class="hero-header-content">
            <div class="hero-header-left">
                ...
                <div class="hero-title-section">
                    <h1 class="hero-main-title">Create Featured Highlight</h1>
                    <p class="hero-subtitle">Add a new image or video highlight to showcase your work</p>
                </div>
            </div>
    ...
    <div class="hero-content">
        <div class="form-container">
            <form action="{{ route('admin.featured-highlights.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                               value="{{ old('title') }}" placeholder="e.g., Our Latest Project" required>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="type-selector">
                            <label class="type-option {{ old('type', 'image') === 'image' ? 'active' : '' }}">
                            ...
                            <label class="type-option {{ old('type') === 'video' ? 'active' : '' }}">
