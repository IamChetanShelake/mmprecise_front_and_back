...
<div id="team" class="section active">
        ...
        <div class="form-header-content">
            <div class="form-header-left">
                ...
                <div class="form-title-section">
                    <h1 class="form-main-title">Add Team Member</h1>
                    <p class="form-subtitle">Add a new team member to showcase your company's staff</p>
                </div>
            </div>
    ...
    <div class="form-container">
        <div class="form-main">
            <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="name" name="name" value="{{ old('name') }}" placeholder="Full name of the team member" required>
                            </div>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-input" id="role" name="role" value="{{ old('role') }}" placeholder="e.g. Developer, Designer, Manager" required>
                            </div>
                            @error('role')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
        ...
        <div class="form-sidebar">
            ...
            <div class="stats-card">
                ...
                <div class="stats-content">
                    ...
                    <div class="field-requirement">
                        <span class="field-name">Member Role:</span>
                        <span class="field-status required">Required</span>
                    </div>
                    <div class="field-requirement">
