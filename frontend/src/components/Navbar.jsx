        ...
        <div className="hidden md:flex items-center space-x-8 md:pl-28">
          ...
          >
            <div className="flex  items-center cursor-pointer hover:text-primary transition-colors duration-200">
              About
              {aboutSubmenu ? (
                <FiChevronUp size={24} className="inline-block px-1" />
              ) : (
                <FiChevronDown size={24} className="inline-block px-1" />
              )}
            </div>
            {aboutSubmenu && (
            ...
            <div className="relative">
              ...
              {aboutSubmenu && (
                <div className="ml-4 mt-2 space-y-3 text-base">
                  <Link to="/about-us" onClick={handleLinkClick} className="block hover:text-primary">About Us</Link>
                  <Link to="/leadership" onClick={handleLinkClick} className="block hover:text-primary">Leadership</Link>
                </div>
              )}
